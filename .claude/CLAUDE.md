...
components/
  ...
  agenda/AgendaWeekView.tsx      Grilla semanal (tema claro), usada solo en /dashboard/agenda/calendario — eventos clickeables, abren AgendaEventModal.tsx
  agenda/AgendaMonthView.tsx     Grilla mensual (tema oscuro), usada solo en /agenda-tv — sin click, pensada para verse a distancia (kiosco TV)
  agenda/AgendaKioskHeader.tsx   Topbar de ambas vistas — prop theme (dark/light), swapea el logo según tema
  agenda/AgendaEventModal.tsx    Modal de detalle de un evento (solo lectura) — usado por AgendaWeekView
